/***************************************************
	CSCI 440  Assignment 7
	Ian Finlayson 2006

	The penguin walks around the Y axis again, but
	this time he casts a shadow onto the Y=0 plane
***************************************************/
...
void drawPenguin( int is_shadow )
{
	...
	if( is_shadow )
	{
		/* black and orange are both grey for a shadow */
		black[0] = black[1] = black[2] = 0.2;
...
void display( void )
{
	...
	glPopMatrix( );	/* Undo penguin-centric transformations */
