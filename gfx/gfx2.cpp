/***********************************************
	...
	and make him walk in a circle, move his feet,
	wobble back and forth and flap his wings.
***********************************************/
...
/* You can't tell it's a real circle because of the lack of perspective,
   but I've tried it with perspective , and it is correct */
...
void reshape( int w, int h )
{
	...
	/* world has been expanded from program 1 so that
	   there is room for the penguin to walk about */
