...
// Constructor
Window::Window( int width, int height, int bpp, const char* title )
{
	// I get errors if I break this up...
	char* text = "Santa Walker\nBy Ian Finlayson\n\nThis is a demo featuring Santa Claus walking around his christmas tree (perhaps he had too much egg nog).\n\nYou can move the camera with the arrow keys and zoom in or out with the \'O\' and \'L\' keys.\nYou can quit at any time by pressing escape.\n\nWould you like fullscreen?";

	// find out if we're in fullscreen...
	full = ( MessageBox( NULL, text, "Santa", MB_YESNO | MB_ICONQUESTION ) == IDYES );
